function [ a, cb ] = niak_visu_surf_vMax( data, surf, opt);
...
%Modified Feb 2014, Maxime Pelland. Removed the automatic light that was
%set in order to set own light during figure creation. 
...
for num_v = 1:length(list_view)   
    ...
    daspect([1 1 1]); axis tight;axis vis3d off;
