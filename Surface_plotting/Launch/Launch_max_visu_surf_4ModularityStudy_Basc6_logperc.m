function Launch_max_visu_surf_4ModularityStudy_Basc6_logperc(basePath),
...
if stats,
    ...
    if ~isempty(strfind(basePath,'Diff'));
        Opti.Limits = [log10(2) log10(36);-log10(36) -log10(2)];
        Opti.CoType = [2 3];
    else
        Opti.Limits = [log10(2) log10(101);-log10(101) -log10(2)];%Opti.Limits = [.01 0.35;-.35 -.01];
        Opti.CoType = [2 3];
    end
end
