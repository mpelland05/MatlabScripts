...
im = 1;
files_in.data{im} = 'H:\MyStudies\Modularity\Modularity_Pierre_Corrections_2017\fmri\region_growing_rand_OccMaskAALetBASC_RL\Atoms_randWhole_BASC6only_Rigth.nii';%-------------------------------------------------------------------------
opt.coType(im,1) = 17;
opt.contour.show(im,1) = 0;
opt.contour.color(im,:) = [1 0 1];
opt.limits.minmax(im,:) = [0.3 403];
...
im = 2;
files_in.data{im} = 'H:\MyStudies\Modularity\Modularity_Pierre_Corrections_2017\fmri\region_growing_rand_OccMaskAALetBASC_RL\Atoms_randWhole_BASC6only_Left.nii';%-------------------------------------------------------------------------
opt.coType(im,1) = 17;
opt.contour.show(im,1) = 0;
opt.contour.color(im,:) = [1 0 1];
opt.limits.minmax(im,:) = [0.3 403];
