...
bpath = 'H:\MyStudies\Modularity\Modularity_Pierre_Corrections_2017\FutureFigures\CompareMaps\Diffs\';
%%%%%%%%%
...
opt.limits.minmax(2,:) = [-0.001 -.35];
opt.limits.over(2,:) = [0 1];
opt.volRefs.vol{2} = 'H:\MatlabToolboxes\Surface_plotting\Models\Vol2Surf\Vol_3mm_NiakBoldOutput.nii'; 
opt.volRefs.surf{2} = 'H:\MatlabToolboxes\Surface_plotting\Models\Vol2Surf\Vol_3mm_NiakBoldOutput_surf.mat';
...
opt.out.subfold = 'Surfacedmin0p001';
opt.seed.show = 0;
opt.rot = [30 0; -30 0; 0 -30;0 -30];
...
files_in.data{2} = strcat(bpath,list_files{ii});
maxime_visu_surf(files_in, files_out, opt)
