function Launch_max_visu_surf_Voxel_thresh(basePath),
...
Opti.Seeds = 1;
Opti.Rot = [30 25; -30 25; 0 -30; 0 -30];% [15 5; -15 5; 0 -30; 0 -30];
...
for pp = 1:length(pnames),
    ...
    max(data)
        ...
        Opti.CoType = [2 3];
        Opti.Limits = [2.048 4; -4 -2.048];%2.467
        data(find(data < Opti.Limits(1,1) & data > 0)) = 0;
        data(find(data > Opti.Limits(2,2) & data < 0)) = 0;
