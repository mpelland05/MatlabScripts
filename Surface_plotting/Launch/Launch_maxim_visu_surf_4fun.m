...
files_in.data{1} = 'H:\MyStudies\ProbAtlas\SurfAtlas_sym\Vol2SurfLong\perc_VTPM_vol_roi4_rh_sym.nii';
opt.coType(1,1) = 1;
opt.contour.show(1,1) = 1;
opt.contour.color(1,:) = [1 0 1];
opt.limits.minmax(1,:) = [10 100];
